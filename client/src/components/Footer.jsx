...
const Footer = () => {
  return (
    <footer className="w-full bg-primary-darker text-text-light py-6 mt-auto">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          <div>
            <h3 className="text-lg font-bold mb-3">learn.mtandaocentre</h3>
        ...
        <div className="border-t border-gray-700 pt-4 text-center text-gray-400 text-sm">
          <p>
            &copy; {new Date().getFullYear()} learning.mtandaocentre. all rights reserved.
          </p>
        </div>
      </div>
    </footer>
